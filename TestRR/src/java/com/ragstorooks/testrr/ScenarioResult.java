...
/**
 * This class encapsulates the details of each scenario that was executed. All of the information is updated by the Runner class so that
 * the testing system can collect and present detailed information about each scenario. 
 */
public class ScenarioResult {
	 ...
	 * @param scenarioType the class that defines the scenario.
	 * @param message defaults to an error message, until the scenario is marked as complete.
	 */
